var htmlFooter = `
	<div class="footer-container">
        ...
        <div class="footer-section footer-copyright">
          ...
          <a href="support-me" target="_blank" class="text-footer" style="text-align: left;">💸 I'm in need of financial aid, support me here!</a>
        </div>
	</div>`;
var htmlNavbar = `
          ...
          <svg width="100%" height="100%" viewBox="0 0 600 600" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">
            <g transform="matrix(1,0,0,1,-1400,-700)">
                <g transform="matrix(1,0,0,1,-2100,700)">
                    <g transform="matrix(1.03512,0,0,1.03512,3496.66,-21.0027)">
